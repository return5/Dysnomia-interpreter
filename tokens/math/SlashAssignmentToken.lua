...
local SlashAssignmentToken <const> = {type = TokenEnums.SlashAssignment}
SlashAssignmentToken.__index = SlashAssignmentToken
setmetatable(SlashAssignmentToken,Token)

_ENV = SlashAssignmentToken

function SlashAssignmentToken:new(tokenizer,str)
	return setmetatable(Token:new(tokenizer,str),self)
end

return SlashAssignmentToken
