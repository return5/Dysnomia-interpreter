...
function Parser:new()
	return setmetatable({current = {},previous = {},hadError = false, panicMode = false},self)
end

local parser <const> = Parser:new()

function Parser.init(current)
